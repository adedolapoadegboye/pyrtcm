...
RTCM_DATA_FIELDS = {
    ...
    "DF16P": (UINT, 30, 1, "GNSS Epoch Time"),
    "DF18P": (UINT, 16, 1, "Extended Week Number"),
    "DF19P": (UINT, 24, 0, "Firmware Version"),
    "DF21P": (UINT, 32, 0, "Constellation Alarm Mask"),
    "DF25P": (UINT, 8, 0, "Configuration Page Number"),
    "DF26P": (UINT, 16, 0, "Configuration Page Mask"),
    ...
    "DF34P": (INT, 32, 0.000001, "Antenna Velocity ECEF-X"),
    "DF35P": (INT, 32, 0.000001, "Antenna Velocity ECEF-Y"),
    "DF36P": (INT, 32, 0.000001, "Antenna Velocity ECEF-Z"),
    "DF37P": (UINT, 8, 0, "Number of Satellites in View"),
    "DF49P": (UINT, 1, 0, "Continue on Next Message"),
    "DF50P": (UINT, 1, 0, "CDB Write Flag"),
    "DF53P": (UINT, 10, 0, "Response ID"),
    "DF54P": (UINT, 16, 0, "Message Response"),
    "DF64P": (UINT, 32, 977.5171, "CPU Timestamp"),
    "DF65P": (INT, 16, 0.061, "Acc Raw X"),
    "DF66P": (INT, 16, 0.061, "Acc Raw Y"),
    "DF67P": (INT, 16, 0.061, "Acc Raw Z"),
    "DF68P": (INT, 16, 4.37, "Gyro Raw X"),
    "DF69P": (INT, 16, 4.37, "Gyro Raw Y"),
    "DF70P": (INT, 16, 4.37, "Gyro Raw Z"),
    "DF71P": (UINT, 8, 0, "Sensor Type"),
    "DF72P": (UINT, 4, 0, "Time ID"),
    "DF73P": (INT, 32, 0.001, "Latitude"),
    "DF74P": (INT, 32, 0.001, "Longitude"),
    "DF75P": (INT, 20, 0.1, "Height"),
    "DF76P": (INT, 20, 0.01, "Velocity Horizontal"),
    "DF77P": (INT, 20, 0.01, "Velocity Vertical"),
    "DF78P": (INT, 16, 0.1, "Course Angle"),
    "DF82P": (UINT, 16, 0, "Signal Identifier"),
    "DF86P": (UINT, 8, 0, "Tracking Mode"),
    "DF87P": (UINT, 4, 0, "Time Validity"),
    "DF95P": (UINT, 32, 0, "GNSS Constellation Mask"),
    "DF96P": (UINT, 32, 0, "GNSS Multi-Frequency Constellation Mask"),
    "DF106P": (UINT, 32, 0, "Odometer"),
